package com.example.aydsII.act3.controller;
...
import com.example.aydsII.act3.service.ConversionService;
...
public class ConversionController {
    ...
    public ResponseEntity<ApiResponse<Conversion>> convertir(@RequestParam @Positive(message = "El monto debe ser mayor que 0") double monto,
                                                            @RequestParam
                                                            @Pattern(
                                                                    regexp = "[A-Za-z]{3}",
